...
--INSERT INTO [dbo].[Fato_Despesas_Departamentos]
SELECT 
...
SELECT 
	...
	tab_b.departamento as DEPARTAMENTO,
	...
	FROM (
		SELECT 
			...
			GROUP BY idEmpresa, dataDespesa, departamento, tipoOperacao, situacaoDespesa, tipoDocumento, tipoPagamento
	
	)tab_b

		WHERE tab_b.dataDespesa BETWEEN '01/01/2020' AND '31/12/2022' AND tab_b.idEmpresa = 10

	GROUP BY tab_b.dataDespesa, tab_b.idEmpresa, tab_b.departamento
